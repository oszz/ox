...
//	public Map<Short, Class<? extends MessageLite>> msgCodeMappings;
	...
	private MessageCodeMapping(){
		msgCodeMappings = new ConcurrentHashMap<Short, TwoTuple<Class<? extends GeneratedMessage>, IMessageHandler>>();
	}
	...
	public void register(Short msgCode, Class<? extends GeneratedMessage> generatedMessageClass, IMessageHandler msgHandler){
		TwoTuple<Class<? extends GeneratedMessage>, IMessageHandler> tt = 
				new TwoTuple<Class<? extends GeneratedMessage>, IMessageHandler>(generatedMessageClass, msgHandler);
