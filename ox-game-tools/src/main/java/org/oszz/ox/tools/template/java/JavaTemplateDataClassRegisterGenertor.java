 ...
 *
 */
public class JavaTemplateDataClassRegisterGenertor extends
		AbstractTemplateGenertor implements ITemplateGenertor {
	
	private String tempDataClassMapping_vmFile;
	
	public JavaTemplateDataClassRegisterGenertor(ModuleConfig moduleConfig, List<TemplateDataConfig> tempDataConfigs,
